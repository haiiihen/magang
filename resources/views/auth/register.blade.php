                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="noHandphone"><i class="zmdi zmdi-phone"></i></label>
                                <div class="col-md-6">
                                <input id="noHandphone" type="text" class="form-control @error('noHandphone') is-invalid @enderror" placeholder="Phone Number" name="noHandphone" value="{{ old('noHandphone') }}" required autocomplete="noHandphone" autofocus>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>all data entered is correct</label>
                            </div> -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="noHandphone" class="col-md-4 col-form-label text-md-right">{{ __('No Ponsel') }}</label>
